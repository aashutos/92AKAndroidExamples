...
import static com.ntak.examples.jobschedulerexample.application.GlobalBus.localTasks;
...
public class BackgroundRenderResourceSubscriber implements Subscriber {
    ...
    @Override
    public void open() {
        if (!localTasks.isRegistered(this))
            localTasks.register(this);
    }
