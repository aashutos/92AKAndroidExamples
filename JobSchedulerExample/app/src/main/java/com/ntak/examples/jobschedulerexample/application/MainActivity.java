        ...
        try {
            ...
            btnNetwork.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    netTasks.post(new NetworkDownloadEvent(url,"output.jpg",getApplicationContext()));
            ...
            btnLocal.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    localTasks.post(new LocalImgManipEvent(new MapBuilder<String,String>(HashMap.class).addEntry("ACTION","TRANS_IMAGE").addEntry("IMAGE_RES","spriteColourChange").build(),getApplicationContext(),R.drawable.andr_green));
